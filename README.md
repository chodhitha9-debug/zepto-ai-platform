...
A modular data and AI platform containing three independent modules:
...
```json
{
  "answer": "Based on the provided policy context: Delivery Policy\n\nStandard delivery is free for orders of INR 149 or more. Orders below INR 149 incur a delivery fee of INR 25. Priority delivery is available for INR 15 and reserves the next available rider.",
  "sources": [
    "doc_01_chunk_0"
  ],
  "confidence": 0.9
...
```powershell
Invoke-RestMethod -Uri "http://127.0.0.1:7860/ask" -Method Post -ContentType "application/json" -Body '{"query":"What is the delivery fee for orders below INR 149?"}'
```
